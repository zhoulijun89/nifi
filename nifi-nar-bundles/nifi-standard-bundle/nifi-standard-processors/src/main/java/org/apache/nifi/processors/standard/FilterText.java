...
public class FilterText extends AbstractProcessor {
    ...
    public static final PropertyDescriptor ROUTE_STRATEGY = new PropertyDescriptor.Builder()
        ...
        .defaultValue(routeAllMatchValue)
        .dynamic(false)
        .build();
    ...
    public void onPropertyModified(final PropertyDescriptor descriptor, final String oldValue, final String newValue) {
        ...
        if (ROUTE_TO_MATCHING_PROPERTY_NAME.getValue().equals(routeStrategy)) {
            for (final String propName : allDynamicProps) {
                newRelationships.add(new Relationship.Builder().name(propName).autoTerminateDefault(true).build());
            }
        } else {
